...
public class ItemController {
    ...
    @GetMapping("/listar")
    List<Item> listar(@RequestParam(name = "nombre", required = false) String nombre, @RequestHeader(name = "token-request", required = false) String token) {
...
//        return itemService.findById(id, cantidad);
    ...
    ResponseEntity<?> obtenerConfig(@Value("${server.port}") String puerto) {
        log.info(texto);
